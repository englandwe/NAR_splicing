...
#Usage: intronHunterPC_3prime.py icSHAPE_file GTF_file threads output_file
                     ...
                     for coder in coding_list:
                         ...
                         for possible_ret in ret_ranges:
                             ...
                             if startex != stopex and len(startex) > 0 and len(stopex) > 0:
                                 ...
                                 #looking for first 70bp of downstream exon
                                 #grab genomic start point of stopex
                                 stopex_start=stopex[0]
                                 #find distance between stopex start and genomic start of suspicious exon
                                 ret_dist=int(stopex_start)-int(possible_ret[0])
                                 ...
                                 if stopex[1] - stopex[0] > 70:
                                     ...
                                     try:
                                         ...
                                         continue
                                     shapeout.append([txname,coder,ret_chr[0],str(stopex_start)]+shapesub)
    return shapeout
